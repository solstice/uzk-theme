...
\begin{frame}
  ...
  \begin{itemize}
  \item Mit dem Setzen der Option \texttt{english} werden der Name der
    Universität sowie die Fakultätsnamen auf Englisch angezeigt
  \item Diese Namen können in der Theme-Datei
    \texttt{beamerthemeUzK.sty} angepasst werden
  \end{itemize}
...
\begin{frame}
  ...
  \begin{block}{Was noch zu tun ist\ldots}
    \begin{itemize}
    \item Das Logo reicht auf der rechten Seite nicht ganz bis zum Rand
    \item Erstellen einer eigenen Titelseite
    \item Die Navigationssymbole sind unter die Fußleiste "`gerutscht"'
    \item Farben für Umgebungen wie \texttt{exampleblock} definieren
    \item \ldots
    \end{itemize}
  \end{block}
